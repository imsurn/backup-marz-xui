...
readonly OWNER="@imsurn"
readonly SPONSORTEXT="Nothing to say!"
readonly SPONSORLINK="https://t.me/imsurn"
    ...
    while true; do
        ...
        case $choice in
            ...
            3)
                ...
                ;;
            4)
                print "Thank you for using @imsurn script. Goodbye!"
                exit 0
                ;;
            *)
...
telegram_progress() {
    ...
    CAPTION="
📦 <b>From </b><code>\${ip}</code> [By <b><a href='https://t.me/imsurn'>@imsurn</a></b>]
<b>➖➖➖➖Sponsor➖➖➖➖</b>
...
discord_progress() {
    ...
    CAPTION="📦 **From** \`${ip}\` [by **[@imsurn](https://t.me/imsurn)**]\n➖➖➖➖**Sponsor**➖➖➖➖\n[${SPONSORTEXT}](${SPONSORLINK})"
    LIMITSIZE=24
...
EOF
            ...
            chmod 600 ~/.muttrc
            CAPTION="<html><body><p><b>📦 From </b><code>\${ip}</code> [by <b><a href='https://t.me/imsurn'>@imsurn</a></b>]</p><p><b>➖➖➖➖Sponsor➖➖➖➖</b></p><p><a href='${SPONSORLINK}'>${SPONSORTEXT}</a></p></body></html>"
...
EOL
    ...
    if bash "$BACKUP_PATH" 2>&1 | tee /tmp/backup.log; then
        ...
        success "Thank you for using @imsurn backup script. Enjoy automated backups!"
        exit 0
    else
